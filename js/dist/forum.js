...
/* harmony import */ var _components_PostLikesModal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/PostLikesModal */ "./src/forum/components/PostLikesModal.js");
    ...
    if (likes && likes.length) {
      items.add('liked', m("a", {
        ...
        onclick: function onclick(e) {
          e.preventDefault();
          flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().modal.show(_components_PostLikesModal__WEBPACK_IMPORTED_MODULE_4__["default"], {
            post: post
          });
        }
      }, m("div", {
        className: "FooterItem Post-likedBy"
      }, flarum_common_helpers_icon__WEBPACK_IMPORTED_MODULE_3___default()('far fa-thumbs-up'), likes.length)));
    }
  });
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ addMentionedByList)
/* harmony export */ });
...
/* harmony import */ var _components_PostMentionsModal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/PostMentionsModal */ "./src/forum/components/PostMentionsModal.js");
...
function addMentionedByList() {
  (flarum_common_models_Post__WEBPACK_IMPORTED_MODULE_3___default().prototype.mentionedBy) = flarum_common_Model__WEBPACK_IMPORTED_MODULE_2___default().hasMany('mentionedBy');
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_components_CommentPost__WEBPACK_IMPORTED_MODULE_4___default().prototype), 'footerItems', function (items) {
    var post = this.attrs.post;
    var replies = post.mentionedBy(); //We change the class to PostMentionedBy so it doesnt open the fucking hover

    if (replies && replies.length) {
      items.add('replies_custom', m("a", {
        href: "#",
        onclick: function onclick(e) {
          e.preventDefault();
          flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().modal.show(_components_PostMentionsModal__WEBPACK_IMPORTED_MODULE_6__["default"], {
            post: post
          });
        }
      }, m("div", {
        className: "FooterItem Post-mentionedBy_custom"
      }, flarum_common_helpers_icon__WEBPACK_IMPORTED_MODULE_5___default()('fas fa-reply'), replies.length)));
    }
  });
}
...
/***/ "./src/forum/components/PostMentionsModal.js":
/*!***************************************************!*\
  !*** ./src/forum/components/PostMentionsModal.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PostMentionsModal)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
/* harmony import */ var flarum_forum_app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flarum/forum/app */ "flarum/forum/app");
/* harmony import */ var flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flarum_forum_app__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var flarum_common_components_Modal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! flarum/common/components/Modal */ "flarum/common/components/Modal");
/* harmony import */ var flarum_common_components_Modal__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(flarum_common_components_Modal__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var flarum_forum_components_PostPreview__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! flarum/forum/components/PostPreview */ "flarum/forum/components/PostPreview");
/* harmony import */ var flarum_forum_components_PostPreview__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(flarum_forum_components_PostPreview__WEBPACK_IMPORTED_MODULE_3__);





var PostMentionsModal = /*#__PURE__*/function (_Modal) {
  (0,_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(PostMentionsModal, _Modal);

  function PostMentionsModal() {
    return _Modal.apply(this, arguments) || this;
  }

  var _proto = PostMentionsModal.prototype;
  ...
  _proto.content = function content() {
    return m("div", {
      ...
      className: "PostMentionsModal-list"
    }, this.attrs.post.mentionedBy().map(function (post) {
      ...
      }, flarum_forum_components_PostPreview__WEBPACK_IMPORTED_MODULE_3___default().component({
        post: post
      })));
    })));
  };

  return PostMentionsModal;
}((flarum_common_components_Modal__WEBPACK_IMPORTED_MODULE_2___default()));
...
/* harmony import */ var _addMentionedByList__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./addMentionedByList */ "./src/forum/addMentionedByList.js");
...
flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().initializers.add('flarum-likes', function () {
  (flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().notificationComponents.postLiked) = _components_PostLikedNotification__WEBPACK_IMPORTED_MODULE_8__["default"];
  ...
  (0,_addMentionedByList__WEBPACK_IMPORTED_MODULE_7__["default"])();
